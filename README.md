...
### 💻 Développement Full Stack & Back-End
...
![Apache Pekko](https://img.shields.io/badge/Apache%20Pekko-E32F27?style=flat&logo=apache&logoColor=white)
...
- 🚀 [**NextOne — Front**](https://github.com/Maeva-RODRIGUES/2411-wns-vert-groupe-4-nextone-front)  
  Application de gestion de file d'attente · React · TypeScript · GraphQL · Docker

- 🔧 [**NextOne — Back**](https://github.com/Maeva-RODRIGUES/2411-wns-vert-groupe-4-nextone-back)  
  API GraphQL · Node.js · TypeORM · PostgreSQL · Docker

- 🛠️ [**Startup MVP**](https://github.com/Maeva-RODRIGUES/startup-MVP)  
  Application web · Next.js · Authentification · API
...
- ⚙️ **Orchestration Demo** *(à venir)*  
  Workflows distribués · Temporal

### 📈 Data Tools & Visualisation

- 📈 **Streamlit App** *(à venir)*  
  Dashboard métier connecté à un pipeline de données · Python · Streamlit

- 📋 **Quarto Report** *(à venir)*  
  Reporting automatisé à partir de données traitées · Quarto · Python

### 🎨 Projet associatif

- 🏛️ [**Ludi Muséo — Dédale**](https://github.com/ludimuseo)  
  Participation au développement d'outils numériques et sensoriels pour l'accessibilité dans les musées *(projet privé)*

---

## 📊 Statistiques GitHub

![Top Langs](https://github-readme-stats-salesp07.vercel.app/api/top-langs/?username=Maeva-RODRIGUES&layout=compact&theme=radical)

[![GitHub Streak](https://github-readme-streak-stats.herokuapp.com?user=Maeva-RODRIGUES&theme=dark&locale=fr)](https://git.io/streak-stats)
...
⚡ **Fun fact :** je suis obsédée par l'organisation, l'efficacité et l'automatisation. Donc si quelque chose peut être automatisé… il y a de fortes chances que j'aie envie d'essayer. 😄
